...
PKGS=(
    ...
    # SYSTEM UTILITIES ----------------------------------------------------
     ...
     'vimix-cursors'               # An X Cursor theme inspired by Material design and based on capitaine-cursors
      #'win11-icon-theme-git'        # A colorful Design icon theme for linux desktops
      #'win10x-icon-theme-git'       # A colorful Design icon theme for linux desktops
     'kwin-scripts-window-colors'  # KWin script that sends to Latte, window color schemes
     'whitesur-kde-theme-git'      # MacOS big sur like theme for KDE Plasma
